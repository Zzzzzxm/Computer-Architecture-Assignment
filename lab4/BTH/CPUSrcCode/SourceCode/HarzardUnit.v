...
module HarzardUnit(
    ...
    input wire BranchE, JalrE, JalD, PredictedE, PredictedTE,
	...
	begin
		...
		else if((BranchE && ~PredictedE) || (PredictedE && (BranchE ^ PredictedTE)))
	...
	always@(*)		//Rs2的转�?
	begin
		if((RegReadE[0])&&(RegWriteM != 0)&&(RdM == Rs2E)&&(RdM != 0))
			Forward2E <= 2'b10;
		else if((RegReadE[0])&&(RegWriteW != 0)&&(RdW == Rs2E)&&(RdW != 0))
			Forward2E <= 2'b01;
		else
			Forward2E <= 2'b00;
	end
